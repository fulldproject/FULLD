...
export const AppsIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="4" height="4" x="4" y="4" rx="1" /><rect width="4" height="4" x="10" y="4" rx="1" /><rect width="4" height="4" x="16" y="4" rx="1" /><rect width="4" height="4" x="4" y="10" rx="1" /><rect width="4" height="4" x="10" y="10" rx="1" /><rect width="4" height="4" x="16" y="10" rx="1" /><rect width="4" height="4" x="4" y="16" rx="1" /><rect width="4" height="4" x="10" y="16" rx="1" /><rect width="4" height="4" x="16" y="16" rx="1" /></svg>
);
...
export const InfoIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><line x1="12" x2="12" y1="16" y2="12" /><line x1="12" x2="12" y1="8" y2="8" /></svg>
);
...
export const CarIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-1.1 0-2 1-2 2v4c0 .6.4 1 1 1h2" /><circle cx="7" cy="17" r="2" /><circle cx="17" cy="17" r="2" /><path d="M13 17h2" /></svg>
);
...
export const AppleIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 256 315" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" fill="currentColor"><path d="M213.803 167.03c.442 47.58 41.74 63.413 42.147 63.615-.35 1.116-6.599 22.563-21.757 44.716-13.104 19.153-26.705 38.235-48.13 38.63-21.027.394-27.807-12.425-51.847-12.425-24.032 0-31.548 12.039-51.846 12.823-20.3.774-35.8-20.73-49.006-39.782-26.99-38.968-47.61-110.156-19.953-158.11 13.73-23.79 38.25-38.825 64.7-39.215 20.252-.39 39.382 13.628 51.722 13.628 12.332 0 35.535-16.854 59.982-14.362 10.25.426 39.04 4.128 57.51 31.186-.445.274-34.193 19.933-33.82 59.706M176.622 35.152C186.963 22.57 193.926 5.064 192.034 0c-14.983.606-33.103 10.02-43.832 22.56-9.605 11.12-18.005 28.98-15.917 46.056 16.711 1.288 33.992-10.887 44.337-23.464" /></svg>
);
...
export const ExpandIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m15 3 6 6" /><path d="M9 21 3 15" /><path d="M21 3v6" /><path d="M21 3h-6" /><path d="M3 21v-6" /><path d="M3 21h6" /></svg>
);
